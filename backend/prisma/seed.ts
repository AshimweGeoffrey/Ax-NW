...
async function main() {
  ...
  // Create sample users from existing data
  const existingUsers = [
    {
      name: "Ashimwe_Geoffrey",
      email: "ashimwegeoffrey@gmail.com",
      password: await bcrypt.hash("Geoffrey@2024", 12),
      accessControl: "Administrator",
    },
    {
      name: "Muvunyi_Jimmy",
      email: "muvunyijdieu1@gmail.com",
      password: await bcrypt.hash("Jimmy@2024", 12),
      accessControl: "Sale_Manager",
    },
    {
      name: "Sibomana_Eugene",
      email: "sibomanaeugene69@gmail.com",
      password: await bcrypt.hash("Eugene@2024", 12),
